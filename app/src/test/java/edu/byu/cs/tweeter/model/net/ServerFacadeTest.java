...
//        final String URL_PATH = "get-followees";
//        FollowingRequest request = new FollowingRequest(user1.getAlias(), 10, null);
//        List<User> followees = Collections.emptyList();
//        FollowingResponse response = new FollowingResponse(followees, true);
//        Mockito.when(serverFacadeSpy.getFollowees(request, URL_PATH)).thenReturn(response);
//
//
