...
import edu.byu.cs.tweeter.model.service.proxyInterface.IFollowingService;
...
public class FollowingPresenter {
    ...
    public FollowingResponse getFollowing(FollowingRequest request) throws IOException, TweeterRemoteException {
        IFollowingService followingService = getFollowingService();
     ...
     * @return the instance.
     */
    IFollowingService getFollowingService() {
